...
package Module1s.service.persistence.impl;

import Module1s.exception.NoSuchStudentException;

import Module1s.model.Student;
import Module1s.model.StudentTable;
import Module1s.model.impl.StudentImpl;
import Module1s.model.impl.StudentModelImpl;

import Module1s.service.persistence.StudentPersistence;
import Module1s.service.persistence.StudentUtil;
import Module1s.service.persistence.impl.constants.Module1PersistenceConstants;
...
public class StudentPersistenceImpl
	...
	@Override
	@Reference(
		target = Module1PersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = Module1PersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
