...
import Module1s.model.StudentModel;
...
/**
 * The base model implementation for the Student service. Represents a row in the &quot;Module1_Student&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StudentModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Module1_Student";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Module1_Student (uuid_ VARCHAR(75) null,studentId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,firstName VARCHAR(75) null,lastName VARCHAR(75) null,age INTEGER)";

	public static final String TABLE_SQL_DROP = "drop table Module1_Student";

	public static final String ORDER_BY_JPQL =
		" ORDER BY student.firstName ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Module1_Student.firstName ASC";
	...
	public Student cloneWithOriginalValues() {
		...
		studentImpl.setAge(this.<Integer>getColumnOriginalValue("age"));
