...
public class StudentLocalServiceWrapper
	 ...
	 */
	@Override
	public Module1s.model.Student addStudent(Module1s.model.Student student) {
	 ...
	 */
	@Override
	public Module1s.model.Student createStudent(long studentId) {
	 ...
	 */
	@Override
	public Module1s.model.Student deleteStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public Module1s.model.Student deleteStudent(
		Module1s.model.Student student) {
	...
	@Override
	public Module1s.model.Student fetchStudent(long studentId) {
	 ...
	 */
	@Override
	public Module1s.model.Student fetchStudentByUuidAndGroupId(
	 ...
	 */
	@Override
	public Module1s.model.Student getStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public Module1s.model.Student getStudentByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<Module1s.model.Student> getStudents(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<Module1s.model.Student> getStudentsByUuidAndCompanyId(
	...
	public java.util.List<Module1s.model.Student> getStudentsByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<Module1s.model.Student>
			orderByComparator) {
	 ...
	 */
	@Override
	public Module1s.model.Student updateStudent(
		Module1s.model.Student student) {
